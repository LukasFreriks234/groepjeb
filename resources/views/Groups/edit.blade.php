                        ...
                        @foreach($group->functions as $function)
                            <div class="function-row">
                                <select name="function_ids[]">
                                    @foreach($functions as $availableFunction)
                                        <option
                                            value="{{ $availableFunction->id }}"
                                            {{ $availableFunction->id == $function->id ? 'selected' : '' }}
                                        >
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="{{ old('relationship_safety', $relationshipSafety) }}"
                            min="-10"
                            max="10"
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            class="relationship-effect-input"
                            value="{{ old('relationship_recreation', $relationshipRecreation) }}"
                            min="-10"
                            max="10"
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            class="relationship-effect-input"
                            value="{{ old('relationship_environmental', $relationshipEnvironmental) }}"
                            min="-10"
                            max="10"
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            class="relationship-effect-input"
                            value="{{ old('relationship_services', $relationshipServices) }}"
                            min="-10"
                            max="10"
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            class="relationship-effect-input"
                            value="{{ old('relationship_mobility', $relationshipMobility) }}"
                            min="-10"
                            max="10"
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            name="safety"
                            class="effect-input"
                            value="{{ old('safety', $group->safety ?? 0) }}"
                            min="-10"
                            max="10"
                        >
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            name="recreation"
                            class="effect-input"
                            value="{{ old('recreation', $group->recreation ?? 0) }}"
                            min="-10"
                            max="10"
                        >
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            class="effect-input"
                            value="{{ old('environmental_quality', $group->environmental_quality ?? 0) }}"
                            min="-10"
                            max="10"
                        >
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            name="services"
                            class="effect-input"
                            value="{{ old('services', $group->services ?? 0) }}"
                            min="-10"
                            max="10"
                        >
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            name="mobility"
                            class="effect-input"
                            value="{{ old('mobility', $group->mobility ?? 0) }}"
                            min="-10"
                            max="10"
                        >
                    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const inputs = document.querySelectorAll(
                '.effect-input, .relationship-effect-input'
            );
        ...
        const container =
            document.getElementById('functionContainer');
        ...
        if (addButton && container) {
            ...
            document
                .querySelectorAll('.remove-function')
                .forEach(button => {
        ...
        const relatedGroup =
            document.getElementById('related_group');
